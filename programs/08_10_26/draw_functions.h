...
void draw_line_horizontal(uint16_t fb, int sx, int dx, int y, uint16_t color);
...
// @param   {uint16_t color} color of the line you just drew
void draw_line_vertical(uint16_t fb, int sy, int dy, int x, uint16_t color);
...
void draw_rect_filled(uint16_t fb, int x, int y, int w, int h, uint16_t color);
